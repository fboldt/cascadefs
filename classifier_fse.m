function cfse = classifier_fse(fsmethod, baseclassifier, numberofclassifiers)
%
% cfse = classifier_fse(fsmethod, baseclassifier, numberofclassifiers)
%
% %Example:
...
% classifier = classifier_fse(fsmethod, baseclassifier, numberofclassifiers)
...
cfse.constructor=@classifier_fse;
cfse.classifiername='OVOEFS - One versus One Ensemble Feature Selection';
...
randens = classifier_random_ensemble(fscla, cfse.numberofclassifiers, 1, 0.9);
else
randens = classifier_random_ensemble(fscla, 1, 1);
end
ovocla = classifier_onevsone(randens); 
